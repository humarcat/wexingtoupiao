...
return array(
	...
	//用户表,sys_user
		...
		"area_val" => array("val" => 1,"w" => 0), //值
		"area_tag" => array("val" => 1,"w" => 50), //附近建筑
		"area_pin" => array("val" => 1,"w" => 50), //附近建筑
		"area_jian" => array("val" => 1,"w" => 50), //附近建筑
	),
	"sys.config" => array(
	//用户表,sys_user
	...
	//用户表,sys_user
		...
		"user_name" => array("val" => 1,"w" => 50), //用户名
		"user_email" => array("val" => 1,"w" => 120), //电子邮箱
		"user_regtime" => array("val" => 1,"w" => 100), //注册时间
		"user_regip" => array("val" => 0,"w" => 50), //注册IP
		"user_loginip" => array("val" => 0,"w" => 50), //登录IP
		"user_netname" => array("val" => 0,"w" => 50), //昵称
		"user_logintime" => array("val" => 1,"w" => 100), //登录时间
		...
		"group_name" => array("val" => 1,"w" => 0), //用户组"
	),
	...
	//用户日志 , sys_user_log;
		...
		"log_addtime" => array("val" => 1,"w" => 100), //时间
