 ...
 */
class cls_pinyin{
	static function get($str_x, $str_code = 'gb2312') {
	...
	static function _get($msg_num, $str_data) { 
	...
	static function get_utf8_gb($msg_x) { 
		$str_x = ''; 
	...
	static function get_combine($msg_arr1, $msg_arr2) { 
